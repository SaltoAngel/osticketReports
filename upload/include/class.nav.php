...
class StaffNav {
    ...
    function getTabs(){
        ...
        if(!isset($this->tabs)) {
            ...
            $this->tabs['reportes'] = array('desc' => __('Reportes'),'href' => 'reportes.php','title' => __('Generar Reportes'));
        ...
        foreach($this->getTabs() as $k=>$tab){
            ...
            switch(strtolower($k)){
                ...
                case 'users':
                    ...
                    break;
                case 'reportes':
                    $subnav[] = array('desc' => __('Generar Reportes'), 'href' => 'reportes.php', 'iconclass' => 'pages');
                    $subnav[] = array('desc' => __('Tickets'), 'href' => 'reportes.php?a=tickets', 'iconclass' => 'tickets');
                    $subnav[] = array('desc' => __('Agentes'), 'href' => 'reportes.php?a=agentes', 'iconclass' => 'users');
                    $subnav[] = array('desc' => __('SLA'), 'href' => 'reportes.php?a=sla', 'iconclass' => 'lists');
                    break;
                case 'kbase':
