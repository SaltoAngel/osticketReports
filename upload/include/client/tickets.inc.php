...
<table id="ticketTable" width="800" border="0" cellspacing="0" cellpadding="0">
    ...
    <thead>
        <tr>
            ...
            <th width="100">
                <a href="tickets.php?sort=date&order=<?php echo $negorder; ?><?php echo $qstr; ?>" title="<?php echo sprintf('%s %s', __('Sort By'), __('Date')); ?>"><?php echo __('Creado');?>&nbsp;<i class="icon-sort"></i></a>
            </th>
            <th width="100">
            ...
            <th width="200">
                <a href="tickets.php?sort=subject&order=<?php echo $negorder; ?><?php echo $qstr; ?>" title="<?php echo sprintf('%s %s', __('Sort By'), __('Subject')); ?>"><?php echo __('Departamento');?>&nbsp;<i class="icon-sort"></i></a>
            </th>
            <th width="160">
   		 <a href="tickets.php?sort=otp&order=<?php echo $negorder; ?><?php echo $qstr; ?>" title="<?php echo sprintf('%s %s', __('Sort By'), __('OTP')); ?>"><?php echo __('Titulo');?>&nbsp;<i class="icon-sort"></i></a>
	    </th>
	    <th width="100">
   		 <a href="tickets.php?sort=assigned&order=<?php echo $negorder; ?><?php echo $qstr; ?>" title="<?php echo sprintf('%s %s', __('Sort By'), __('Name')); ?>"><?php echo __('De');?>&nbsp;<i class="icon-sort"></i></a>
	    </th>
	    <th width="120">
                <a href="tickets.php?sort=dept&order=<?php echo $negorder; ?><?php echo $qstr; ?>" title="<?php echo sprintf('%s %s', __('Sort By'), __('Date')); ?>"><?php echo __('Ult. Act.');?>&nbsp;<i class="icon-sort"></i></a>
            </th>
	    <th width="120">
                <a href="tickets.php?sort=dept&order=<?php echo $negorder; ?><?php echo $qstr; ?>" title="<?php echo sprintf('%s %s', __('Sort By'), __('Nme')); ?>"><?php echo __('Asignado');?>&nbsp;<i class="icon-sort"></i></a>
            </th>
    ...
    <?php
     ...
     $otp = TicketForm::objects()->one()->getField('otp');
     ...
     if ($tickets->exists(true)) {
         foreach ($tickets as $T) {
            ...
            <tr id="<?php echo $T['ticket_id']; ?>">
                ...
                <td>
                  <?php if ($isCollab) {?>
                    <div style="max-height: 1em; max-width: 200px;" class="link truncate" href="tickets.php?id=<?php echo $T['ticket_id']; ?>"><i class="icon-group"></i> <?php echo $subject; ?></div>
                  <?php } else {?>
                    <div style="max-height: 1em; max-width: 200px;" class="link truncate" href="tickets.php?id=<?php echo $T['ticket_id']; ?>"><?php echo $subject; ?></div>
                    <?php } ?>
                </td>
               <td>
		 <div style="max-height: 1em; max-width:160px;" class="link truncate"
			 href="tickets.php?id=<?php echo $T['ticket_id']; ?>"><?php echo $T['cdata__otp'];?>
		</div> 
	       </td>

		<td><?php echo $T['user__name']; ?></td>
		<td><?php echo Format::datetime($T['lastupdate']); ?></td>
		<td><?php echo $T['staff__firstname'] . ' ' . $T['staff__lastname']; ?></td>
